...
// Modelo/BranchRestaurant.php

class BranchRestaurant extends Model {
...
//a menos que en esta clase se redefinan ciertos metodos
    ...
    public function update($usuario) {
        ...
        try {
            $respuesta = file_get_contents($this->getUrl() . '/api/branchRestaurant/' . $id, false, $context);
            var_dump($respuesta);
            return $respuesta;
